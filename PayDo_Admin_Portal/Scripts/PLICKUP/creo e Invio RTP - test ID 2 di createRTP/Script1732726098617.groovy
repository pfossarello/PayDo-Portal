...
ResponseRTP = WS.sendRequest(findTestObject('Object Repository/PLICKUP/CREATE SEND RTP/Create Send', [('Environment') : GlobalVariable.Path, ('Token') : Token, ('areaCode') : areaCode,('expiredAt'):expiredAtnew,('name_retail_template'):name_retail_template,('channel_retail_template'):channel_retail_template, ('recipient_retail_template'):recipient_retail_template,('name_agent_template'):name_agent_template,('channel_agent_template'):channel_agent_template, ('recipient_agent_template'):recipient_agent_template] ))
