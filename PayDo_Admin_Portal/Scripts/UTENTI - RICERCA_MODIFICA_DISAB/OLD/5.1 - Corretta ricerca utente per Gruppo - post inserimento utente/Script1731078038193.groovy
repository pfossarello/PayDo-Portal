...
WebUI.callTestCase(findTestCase('Test Cases/UTENTI - INSERIMENTO/3 - Creazione nuovo utente Admin Callcenter con associati 3 prodotti'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/UTENTI - INSERIMENTO/1 - Creazione nuovo utente AdminPayDo con associati 3 prodotti/Page_PlickUp-Admin/Page_PlickUp-Admin/Page_PlickUp-Admin/div_Quence_z-10 absolute top-3 left-3 right-3 bottom-3 group-hoverbg-skin-fillTo label-checkedbg-skin-fillTo opacity-10 cursor-pointer'))
WebUI.delay(3)
...
WebElement table = WebUI.findWebElement(findTestObject('Object Repository/UTENTI - INSERIMENTO/1 - Creazione nuovo utente AdminPayDo con associati 3 prodotti/Page_PlickUp-Admin/div_NomeCognomeEmailRuoloGruppiPyxcxXBdtiOQpUidtest1730822353807example.comAdmin PayDoModificaCambia passwordDisabilitaDiegoArnotest1730821575454example.comAdmin PayDoModificaCambia passwordDisabilitaPetroCognecogneyopma'))
