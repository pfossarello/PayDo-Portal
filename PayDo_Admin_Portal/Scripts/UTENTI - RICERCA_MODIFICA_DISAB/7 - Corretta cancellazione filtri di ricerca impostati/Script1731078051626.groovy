...
WebUI.click(findTestObject('Object Repository/UTENTI - RICERCA_MODIFICA_DISAB/7 - Corretta cancellazione filtri di ricerca impostati/Page_PlickUp-Admin/svg_Cerca per gruppo_Componente_11_1'))

TestObject campoNome = findTestObject('Object Repository/UTENTI - RICERCA_MODIFICA_DISAB/2- Gestione Utenti - Corretta ricerca utente per Nome Cognome/Page_PlickUp-Admin/input_Filtri_firstName')
TestObject campoCognome = findTestObject('Object Repository/UTENTI - RICERCA_MODIFICA_DISAB/2- Gestione Utenti - Corretta ricerca utente per Nome Cognome/Page_PlickUp-Admin/input_Filtri_lastName')

String Nome = WebUI.getAttribute(campoNome, 'value')
String Cognome = WebUI.getAttribute(campoCognome, 'value')
println Nome
println Cognome

WS.verifyMatch(Nome, "", true)
WS.verifyMatch(Cognome, "", true)
WebUI.closeBrowser()
