...
String Causale_pratica = WebUI.getText(findTestObject('Object Repository/DASHBOARD_FILTRI/7 - 8 - corretto re-invio del Plick e verifica nel dettaglio/Page_PlickUp-Admin/Causale - dettaglio'))
println(Causale_pratica)



//filtro per la causale trovata
WebUI.setText(findTestObject('Object Repository/DASHBOARD_FILTRI/FILTRI APPOGGIO/Page_PlickUp-Admin/Causale'), Causale_pratica)
WebUI.click(findTestObject('Object Repository/DASHBOARD_FILTRI/3 - Filtri - corretta forzatura stato pratica - (da creata a pagata)/Page_PlickUp-Admin/button-filtraggio'))
...
String Causale_pratica_recuperata = ""
...
// Trova tutte le righe all'interno della tabella
	...
	//dal dettaglio pratica del primo record estraggo i valori sotto
		WebUI.click(findTestObject('Object Repository/DASHBOARD_FILTRI/4 - Filtri - corretto aggiornamento stato pratica nel dettaglio - da creata a pagata/Page_PlickUp-Admin/Apri_dettaglio'))
		Causale_pratica_recuperata = WebUI.getText(findTestObject('Object Repository/DASHBOARD_FILTRI/7 - 8 - corretto re-invio del Plick e verifica nel dettaglio/Page_PlickUp-Admin/Causale - dettaglio'))
		println(Causale_pratica_recuperata)
		WebUI.verifyMatch(Causale_pratica_recuperata, Causale_pratica, true)
		...
		WebUI.verifyMatch(Metodo_pagamento, "PISP", true)
			...
			// Controlla se NON siamo all'ultima riga della tabella
				if (k < rows1.size() - 1) { // Se non è l'ultima riga
					...
					WebUI.delay(1) // Aspetta che il dettaglio venga caricato
							...
							println(Causale_pratica_recuperata)
							WebUI.verifyMatch(Causale_pratica_recuperata, Causale_pratica, true)
							Metodo_pagamento2 = WebUI.getText(findTestObject('Object Repository/DASHBOARD_FILTRI/9 - 12 - Filtri - corretto filtraggio per Causale e Metodo di pagamento - PISP/Metodo pagamento'))
							println(Metodo_pagamento2)
							WebUI.verifyMatch(Metodo_pagamento2, "PISP", true)
