...
String data_cambio_stato_inviata = WebUI.getText(findTestObject('Object Repository/DASHBOARD_FILTRI/6 - Filtri - corretto aggiornamento stato pratica nel dettaglio - da inviata a pagata/data cambio stato in inviata'))
println(data_cambio_stato_inviata)

String data_cambio_stato_pagata = WebUI.getText(findTestObject('Object Repository/DASHBOARD_FILTRI/4 - Filtri - corretto aggiornamento stato pratica nel dettaglio - da creata a pagata/Page_PlickUp-Admin/data cambio stato in pagata'))
println(data_cambio_stato_pagata)
...
WebUI.verifyMatch(data_cambio_stato_pagata, todayString, true)
WebUI.verifyMatch(data_cambio_stato_inviata, Ultimo_stato, true)
