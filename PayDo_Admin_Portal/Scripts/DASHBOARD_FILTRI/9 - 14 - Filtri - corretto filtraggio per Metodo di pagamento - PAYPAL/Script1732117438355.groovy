...
WebUI.click(findTestObject('Object Repository/DASHBOARD_FILTRI/9 - 14 - Filtri - corretto filtraggio per Metodo di pagamento - PAYPAL/span_Created_2'))
...
// Trova tutte le righe all'interno della tabella
	...
	//dal dettaglio pratica del primo record estraggo i valori sotto
		...
		WebUI.verifyMatch(Metodo_pagamento, "PAYPAL", true)
