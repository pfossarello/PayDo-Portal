...
WebUI.setText(findTestObject('Object Repository/GRUPPI/1 - 12 - Corretta creazione nuovo gruppo con un cliente associato e successiva eliminazione/input_Elementi per pagina_name'), 'ClienteTestMOD2P')

WebUI.setText(findTestObject('Object Repository/GRUPPI/1 - 12 - Corretta creazione nuovo gruppo con un cliente associato e successiva eliminazione/input_Nome gruppo_description'), 'DescrizioneClienteMOD2P')
...
WebUI.setText(findTestObject('Object Repository/GRUPPI/Page_PlickUp-Admin/input_Gestione gruppi_name'), 'ClienteTestMOD2P')


WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/GRUPPI/Page_PlickUp-Admin/svg_ClienteTestMOD2P_inline-block w-5 h-5'))

WebUI.delay(1)

WebUI.setText(findTestObject('Object Repository/GRUPPI/1 - 12 - Corretta creazione nuovo gruppo con un cliente associato e successiva eliminazione/input_Elementi per pagina_name'), 'ClienteTestMOD2PULT')

WebUI.setText(findTestObject('Object Repository/GRUPPI/1 - 12 - Corretta creazione nuovo gruppo con un cliente associato e successiva eliminazione/input_Nome gruppo_description'), 'DescrizioneClienteMOD2PULT')
...
// Seleziona l'opzione casuale
select1.selectByValue(randomOption1.getAttribute('value'))

// Stampa l'opzione selezionata nella console
WebUI.comment("Opzione selezionata: " + randomOption1.getText())

// Crea un TestObject per l'opzione selezionata
TestObject selectedOptionObject1 = new TestObject()
selectedOptionObject1.addProperty('xpath', ConditionType.EQUALS, "//option[@value='${randomOption1.getAttribute('value')}']")

// Esegui il doppio clic sull'opzione selezionata
WebUI.doubleClick(selectedOptionObject1)

// Aggiungi un'attesa per osservare l'azione
WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/GRUPPI/Page_PlickUp-Admin/button_Aggiorna'))

TestObject dynamicSpanObject2 = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//span[contains(text(), \'Gruppo modificato\')]')
...
WS.verifyMatch(esito2, 'Gruppo modificato', true)
...
WebUI.setText(findTestObject('Object Repository/GRUPPI/Page_PlickUp-Admin/input_Gestione gruppi_name'), 'ClienteTestMOD2PULT')
...
TestObject dynamicSpanObject4 = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//span[contains(text(), \'Gruppo eliminato\')]')

TestObject dynamicSpanObject5 = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//span[contains(text(), \'Operazione eseguita con successo\')]')

String esito4 = WebUI.getText(dynamicSpanObject4)

println(esito1)

WS.verifyMatch(esito4, 'Gruppo eliminato', true)
