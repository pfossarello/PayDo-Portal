...
WebUI.setText(findTestObject('Object Repository/LOGIN/Login 2/Page_PlickUp-Admin/input_accedi_username'), 'paolofossarello@libero.it')

WebUI.setEncryptedText(findTestObject('Object Repository/LOGIN/Login 2/Page_PlickUp-Admin/input_accedi_password'), 'ZBKkrqkHhA4XCcNHIH9Odw==')
