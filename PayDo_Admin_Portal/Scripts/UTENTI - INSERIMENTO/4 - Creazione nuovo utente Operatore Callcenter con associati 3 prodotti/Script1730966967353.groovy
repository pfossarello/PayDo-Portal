...
TestObject labelObject = new TestObject().addProperty(
	...
	"//p[contains(@class, 'text-right w-28 font-mediumMontserrat text-lg') and contains(text(), 'Operatore Callcenter')]"
)
...
List<WebElement> elements = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/UTENTI - INSERIMENTO/4 - Creazione nuovo utente Operatore Callcenter con associati 3 prodotti/Page_PlickUp-Admin/Dropdown gruppi'), 30)
println elements
...
String modifiedRuolo =  Ruolo.replace("Operatore Call Center", "Operatore Callcenter")

// Stampa i valori estratti o usali come preferisci
println("Nome: " + nome)
println("Cognome: " + cognome)
println("Email: " + email)
println("Ruolo: " + modifiedRuolo)
...
WS.verifyMatch(modifiedRuolo, ruolo, true)
