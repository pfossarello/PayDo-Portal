...
WebUI.click(findTestObject('Object Repository/CLIENTI/28 - verifica corretta configurazione Template per cliente di primo livello - Template Whatsapp/div_Modifica template'))
String Descrizione = WebUI.getAttribute(findTestObject('Object Repository/CLIENTI/26 - mancato salvataggio configurazione Template per cliente di primo livello - Template Whatsapp/Page_PlickUp-Admin/input_Canale_description'), 'value')
String Sender = WebUI.getAttribute(findTestObject('Object Repository/CLIENTI/26 - mancato salvataggio configurazione Template per cliente di primo livello - Template Whatsapp/Page_PlickUp-Admin/input_Lingua_sender'), 'value')
String Oggetto = WebUI.getAttribute(findTestObject('Object Repository/CLIENTI/26 - mancato salvataggio configurazione Template per cliente di primo livello - Template Whatsapp/Page_PlickUp-Admin/input_Sender_subject'), 'value')
...
WebUI.verifyMatch(Sender, "Retail", true)
WebUI.verifyMatch(Oggetto, "Invio richiesta", true)
