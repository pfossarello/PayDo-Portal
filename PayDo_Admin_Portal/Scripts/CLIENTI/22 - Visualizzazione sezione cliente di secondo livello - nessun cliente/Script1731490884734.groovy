...
/////VERIFICA SEZIONE CLIENTI SECONDO LIVELLO////////////////////////////////////////////////
...
String Label_secondo_livello = WebUI.getText(findTestObject('Object Repository/CLIENTI/22 - Visualizzazione sezione cliente di secondo livello - nessun cliente/Page_PlickUp-Admin/Clienti secondo livello'))
println Label_secondo_livello
String nome2 = nome1.toUpperCase()
String Label_secondo_livello_1 = "CLIENTI SECONDO LIVELLO DI" + " " +  nome1
String messaggio_informativo = WebUI.getText(findTestObject('Object Repository/CLIENTI/22 - Visualizzazione sezione cliente di secondo livello - nessun cliente/Page_PlickUp-Admin/Message assenza clienti secondo livello'))


WebUI.verifyMatch(messaggio_informativo, "Non sono presenti clienti di secondo livello per questo cliente", true)
...
println esito3
WS.verifyMatch(esito3, "Utente eliminato", true)
