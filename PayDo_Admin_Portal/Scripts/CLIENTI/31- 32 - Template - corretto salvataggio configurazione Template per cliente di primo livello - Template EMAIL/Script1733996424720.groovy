...
WebUI.click(findTestObject('Object Repository/CLIENTI/31- 32 - Template - corretto salvataggio configurazione Template per cliente di primo livello - Template EMAIL/div_Aggiungi template_EMAIL'))
WebUI.setText(findTestObject('Object Repository/CLIENTI/31- 32 - Template - corretto salvataggio configurazione Template per cliente di primo livello - Template EMAIL/input_Canale_description_EMAIL'), 'Invio a retail')
WebUI.setText(findTestObject('Object Repository/CLIENTI/31- 32 - Template - corretto salvataggio configurazione Template per cliente di primo livello - Template EMAIL/input_Lingua_sender_EMAIL'), 'Invio a Retail')
WebUI.setText(findTestObject('Object Repository/CLIENTI/31- 32 - Template - corretto salvataggio configurazione Template per cliente di primo livello - Template EMAIL/input_Sender_subject_EMAIL'), 'Retail')
...
WebUI.click(findTestObject('Object Repository/CLIENTI/31- 32 - Template - corretto salvataggio configurazione Template per cliente di primo livello - Template EMAIL/div_Modifica template_EMAIL'))
String Descrizione = WebUI.getAttribute(findTestObject('Object Repository/CLIENTI/31- 32 - Template - corretto salvataggio configurazione Template per cliente di primo livello - Template EMAIL/input_Canale_description_EMAIL'), 'value')
String Sender = WebUI.getAttribute(findTestObject('Object Repository/CLIENTI/31- 32 - Template - corretto salvataggio configurazione Template per cliente di primo livello - Template EMAIL/input_Lingua_sender_EMAIL'), 'value')
String Object = WebUI.getAttribute(findTestObject('Object Repository/CLIENTI/31- 32 - Template - corretto salvataggio configurazione Template per cliente di primo livello - Template EMAIL/input_Sender_subject_EMAIL'), 'value')
...
WebUI.verifyMatch(Object, "Retail", true)
